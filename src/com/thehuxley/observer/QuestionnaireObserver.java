...
public class QuestionnaireObserver extends AbstractObserver {
	...
	protected String getObserverName() {
		return QuestionnaireObserver.class.getName();
	}
	...
	public static void main(String[] args) throws Exception {
		QuestionnaireObserver observer = new QuestionnaireObserver();
